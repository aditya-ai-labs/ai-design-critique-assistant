    ...
    if st.button("Analyze Design"):
        with st.spinner("Analyzing..."):
            ...
            if res.status_code == 200:
                ...
                session["source"] = data.get("source")  # 🔥 track model
...
if session["analysis"]:
    ...
    if session.get("source"):
        st.info(f"🤖 Generated by: {session['source'].upper()}")
...
# else:
#     if session["analysis"]:
#         st.warning("⚠️ Image generation unavailable (check network or API)")
